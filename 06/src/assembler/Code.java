...
public class Code {
	...
	public static String address(String asmAddress)
	{
		String strAddress= Integer.toBinaryString(Integer.valueOf(asmAddress));
		while (strAddress.length()<15) strAddress="0"+strAddress;
		return strAddress;
	}
}
